...
def train_ssl_dss(data_type: str, data_dir: str, y_suffix: str = '',
    ...
    # pdb.set_trace()       
    model_cpc.load_training_configuration(config = params, data_gen = data_gen, val_gen = val_gen, data_type = data_type)
...
if __name__ == '__main__':
    ...
    for gru_units in [16, 32, 64, 128]:
        ...
        train_ssl_dss(data_type = 'flies_multi_channels', data_dir = 'dat/dmel_multi_murthy_raw_manual_sine.npy', y_suffix = '',
        ...
        # train_ssl_dss(data_type = 'flies_single_channel', data_dir = 'dat/dmel_single_raw.npy', y_suffix = '', 
        ...
        # train_ssl_dss(data_type = 'birds_single_channel', data_dir = 'dat/bengfin_single_sober_syllables_allInd_clean.npy', y_suffix = '',
        #               save_dir = 'parameter_search_birds_steps=100', save_prefix = 'birds_' + str(gru_units),
        ...
        #               nb_epoch = 20,
        #               learning_rate = 0.0005, reduce_lr = False, reduce_lr_patience = 5,
        #               fraction_data = None, seed = 1, batch_level_subsampling = False,
        #               tensorboard = False, log_messages = False,
        #               nb_stacks = 2, with_y_hist = True, x_suffix = '',
        #               dilations = [1, 2, 4, 8, 16], activation = 'norm_relu', use_skip_connections = True, dropout_rate = 0.00, padding = 'same',
