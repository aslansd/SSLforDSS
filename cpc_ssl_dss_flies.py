...
class CPCModel(ModelBase):
    ...
    def load_training_configuration(self, config, data_gen, val_gen):
        ...
        if self.model_name == 'tcn_multi':            
            ...
            # x = AveragePooling1D(pool_size = int(self.nb_hist // 100), strides = 100)(x) 
            x = MaxPooling1D(pool_size = int(self.nb_hist // 100), strides = 100)(x)
        ...
        # pooling_features = AveragePooling1D(pool_size = int(self.nb_hist // 100), strides = 100)(intermediate_features) 
        pooling_features = MaxPooling1D(pool_size = int(self.nb_hist // 100), strides = 100)(intermediate_features)
