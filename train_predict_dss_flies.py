...
def train_dss(*, data_dir: str, y_suffix: str = '',
...
if __name__ == '__main__':
    ...
    for gru_units in [16, 32, 64, 128, 256]:
        ...
        for fraction_data in [0.25, 0.5, 0.75, None]:
            ...
            train_dss(data_dir = 'dat/dmel_multi_murthy_raw_manual_sine.npy', y_suffix = '',
            ...
            # train_dss(data_dir = 'dat/dmel_single_raw.npy', y_suffix = '',
